...
<div class="mb-6 flex flex-col md:flex-row items-center justify-between gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-2">
            <div class="bg-blue-500/10 p-2 rounded-lg"><i class="fa-solid fa-file-invoice-dollar text-blue-500"></i></div> Central de Relatórios
        </h2>
        <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Gere análises detalhadas do seu fluxo de caixa.</p>
    </div>
</div>
...
<div class="bg-white dark:bg-darkcard rounded-xl p-6 shadow-sm border border-gray-100 dark:border-darkborder mb-6">
    <form method="GET" action="index.php" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        <input type="hidden" name="pagina" value="relatorios-index">
